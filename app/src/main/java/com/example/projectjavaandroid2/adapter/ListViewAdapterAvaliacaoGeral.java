...
public class ListViewAdapterAvaliacaoGeral extends BaseAdapter {

    private Context context;
    private int layoutId;
    private final ArrayList<AvaliacaoPartial> items;

    public ListViewAdapterAvaliacaoGeral(Context context, int layoutId, ArrayList<AvaliacaoPartial> items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final AvaliacaoPartial row = this.items.get(position);
        View itemView = null;
        ...
        TextView nome = (TextView) itemView.findViewById(R.id.textViewUc);
        nome.setText(row.getUnidadeCurricular());
